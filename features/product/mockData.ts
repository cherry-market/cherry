...
const CATEGORY_IMAGES: Record<string, string[]> = {
  포토카드: [
    ...
    'https://images.unsplash.com/photo-1526045612212-70fad8114247?auto=format&fit=crop&w=400&q=80',
    'https://images.unsplash.com/photo-1592518974558-756553835694?auto=format&fit=crop&w=400&q=80',
    'https://images.unsplash.com/photo-1607462109225-6b64ae2dd3cb?auto=format&fit=crop&w=400&q=80',
  ],
  앨범: [
  ...
  응원봉: [
    ...
    'https://images.unsplash.com/photo-1517260739337-6799d239ce83?auto=format&fit=crop&w=400&q=80',
  ],
  '인형/굿즈': [
    'https://images.unsplash.com/photo-1555445054-8488d05c9584?auto=format&fit=crop&w=400&q=80',
    'https://images.unsplash.com/photo-1572456596277-2e458c973a87?auto=format&fit=crop&w=400&q=80',
    'https://images.unsplash.com/photo-1551029506-0807df4e2031?auto=format&fit=crop&w=400&q=80',
  ...
  '패션/잡화': [
    ...
    'https://images.unsplash.com/photo-1605218427368-35b861280387?auto=format&fit=crop&w=400&q=80',
  ],
};
...
const SEED_PRODUCTS: Product[] = [
  {
    ...
    tags: ['뉴진스', '버니', '풀박스'],
    description:
      '포카 확인만 하고 보관했습니다. 구성품 다 있어요. 박스 상태 최상입니다. 홍대입구역 직거래 가능해요.',
    images: [
      'https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=400&q=80',
      'https://images.unsplash.com/photo-1606103920295-9a091573f160?auto=format&fit=crop&w=400&q=80',
    ],
  ...
  },
  {
    ...
    description:
      '극희귀 공방 포카입니다. 하자 전혀 없고요, 탑로더+뽁뽁이 안전포장해서 보내드립니다.',
    images: [
      'https://images.unsplash.com/photo-1526045612212-70fad8114247?auto=format&fit=crop&w=400&q=80',
    ],
    artist: 'IVE',
